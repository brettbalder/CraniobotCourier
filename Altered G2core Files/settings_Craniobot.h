...
#ifndef INIT_MESSAGE
#define INIT_MESSAGE "Initializing configs to Craniobot settings"
#endif
...
#ifndef COMM_MODE
#define COMM_MODE                   JSON_MODE               // {ej: TEXT_MODE, JSON_MODE, AUTO_MODE
#endif
...
#define STATUS_REPORT_DEFAULTS "line","coor","posx","posy","posz","posa","posb","posc","unit","stat"
...
#define M1_STEPS_PER_UNIT           40                       // {1su:  steps to issue per unit of length or degrees of rotation
#endif
#ifndef M1_POLARITY
...
#define M3_TRAVEL_PER_REV           2.117                 // Screw is 12 threads per inch, or 2.117 mm
#endif
#ifndef M3_MICROSTEPS
#define M3_MICROSTEPS               8
#endif
#ifndef M3_STEPS_PER_UNIT
#define M3_STEPS_PER_UNIT           755.79
#endif
#ifndef M3_POLARITY
...
#define X_VELOCITY_MAX              4000.0                  // {xvm:  G0 max velocity in mm/min
#endif
...
#define Y_SEARCH_VELOCITY           750.0
#endif
...
#define Z_VELOCITY_MAX              500.0
#endif
#ifndef Z_FEEDRATE_MAX
#define Z_FEEDRATE_MAX              500.0
#endif
#ifndef Z_TRAVEL_MAX
...
//// see CranioShield-pinout.h for corresponding Arduino Pin numbers
//// see gpio.h for determining number of input and output digital/analog channels

/* Legend:
 
    IO_ACTIVE_LOW    aka NORMALLY_OPEN = 0
    IO_ACTIVE_HIGH   aka NORMALLY_CLOSED = 1...
    IO_MODE_DISABLED
    ...
    INPUT_ACTION_HALT
    INPUT_ACTION_CYCLE_START (not implimented yet in g2core)
    INPUT_ACTION_ALARM
...
// Future Amin?
#ifndef DI6_MODE
#define DI6_MODE                    IO_ACTIVE_LOW     // Normally closed
#endif
#ifndef DI6_ACTION
...
#endif
#ifndef DI9_ACTION
#define DI9_ACTION                  INPUT_ACTION_RESET
#endif
#ifndef DI9_FUNCTION
...
// cycle start button - NOTE: g2core doesn't support this yet, so the button does nothing as of now.
#ifndef DI11_MODE
#define DI11_MODE                   IO_ACTIVE_LOW     // Normally open
#endif
#ifndef DI11_ACTION
#define DI11_ACTION                 INPUT_ACTION_CYCLE_START
#endif
